...
DEFAULT_MACRO_MAP = {
    ...
    (LOOP_BUTTON, ENCODER1): Actions.noop,
    (LOOP_BUTTON, ENCODER2): Actions.noop,
    (LOOP_BUTTON, ENCODER3): Actions.noop,
    ...
    (REC_BUTTON, ENCODER1): Actions.noop,
    (REC_BUTTON, ENCODER2): Actions.noop,
    (REC_BUTTON, ENCODER3): Actions.noop,
    (REC_BUTTON, ENCODER4): Actions.noop,
    (REC_BUTTON, ENCODER5): Actions.noop,
    (REC_BUTTON, ENCODER6): Actions.noop,
    (REC_BUTTON, ENCODER7): Actions.noop,
    (REC_BUTTON, ENCODER8): Actions.noop,
    (REC_BUTTON, ENCODER9): Actions.noop,
